public static class TagManagement
{
    ...
    public static string PLAYER_IDLE_ANIMATION_BOOL = "Idle";
    public static string PLAYET_RUN_ANIMTION_BOOL = "Run";
    ...
    public static string ENEMY_RISE_ANIMATION_TRIGGER = "Rise";
